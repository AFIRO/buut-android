...
class ValidatePhoneTest {
    ...
    fun phoneIsValidMobileWithoutCountryCode_returnsNull() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("0471234567") // Valid Belgian mobile without country code
        assert(result == null)
    }
    @Test
    fun phoneIsInValidMobileWithoutCountryCode_toLong_returnsError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("04712345670") // Valid Belgian mobile without country code
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
    ...
    fun phoneIsInValidMobileWithoutCountryCode_doesNotStartWithZero_returnsError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("1471234567") // Valid Belgian mobile without country code
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
    ...
    fun phoneIsInValidMobileWithoutCountryCode_secondDigitNot4_returnsError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("0171234567") // Valid Belgian mobile without country code
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
    ...
    fun phoneIsInValidMobileWithCountryCode_toLong_returnsError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("+324712345670") // Valid Belgian mobile without country code
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
    ...
    fun phoneIsInValidMobileWithCountryCode_toShort_returnsError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("+3247123456") // Valid Belgian mobile without country code
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
    @Test
    fun phoneIsInValidMobileWithCountryCode_doesNotStartWithPlus_returnsError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("-32471234567") // Valid Belgian mobile without country code
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
    ...
    fun phoneIsInValidMobileWithCountryCode_countryCodeNotBelgium_returnsError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("+33171234567") // Valid Belgian mobile without country code
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
    ...
    fun phoneIsValidMobileWithDashAndSpace_returnsCorrectError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("+32 4 712 34 567") // Valid Belgian mobile with country code and spaces
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
    ...
    fun phoneIsValidMobileWithCountryCodeAndDash_returnsCorrectError() = scope.runTest {
        val validatePhone = ValidatePhone()
        val result = validatePhone.execute("+32-4-712-34-567") // Valid Belgian mobile with country code and dashes
        assert(result != null)
        assertEquals(UiText.StringResource(resId = R.string.invalid_phone_error).getStringId(), result?.getStringId())
    }
